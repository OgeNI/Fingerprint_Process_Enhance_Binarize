function binarizeImage = binarize_FVC560(grayimage)
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
mean_dark_pixels=mean(gray_img_columnized(gray_img_columnized < 170));
Var_dark_pixels=var(gray_img_columnized(gray_img_columnized < 170));
% -------------------------------------------------------------------------    
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% TYPE I
if mean_dark_pixels < 140 && Var_dark_pixels < 2000 % Global approach is used then for binarization
...
%     Divide image into 16 blocks
    r=[]; 
     for i = 1:rows_image/14:rows_image % step in 1 down the image rows
    %     for i = 1:rows_image/3:rows_image % step in 1 down the image rows
        k=[];
        for j= 1:cols_image/16:cols_image % step in 31 over the image columns
